...
export function DJApplicationScreen() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Use the context's applyToBecomeDJ method
      const result = await applyToBecomeDJ({
